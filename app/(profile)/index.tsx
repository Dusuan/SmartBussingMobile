        ...
        <SafeAreaView> 
            ...
            <View className="h-48 w-90 m-6 rounded-[15px] flex flex-wrap">
                <LinearGradient 
                  ...
                  <Text className="text-xl  ml-28 text-white">correo.ejemplo@cetys.edu.mx</Text>
                </LinearGradient>
            </View>
            ...
            <View className="h-90 w-90 m-6 mt-1 rounded-[15px] bg-white">
              ...
              <Text className="text-3xl ml-24 mt-4 absolute text-black">Rutas Favoritas</Text>
              
              <ScrollView className="h-80 w-90 m-6 mt-1 rounded-[15px] bg-white ">
              {/*Test del scrollview*/}
              <Rutasfavoritas destino={"tamadre"} inicio={"tupu"}/>
              <Rutasfavoritas destino={"tamadre"} inicio={"tupu"}/>
              <Rutasfavoritas destino={"tamadre"} inicio={"tupu"}/>
              <Rutasfavoritas destino={"tamadre"} inicio={"tupu"}/>
              <Rutasfavoritas destino={"tamadre"} inicio={"tupu"}/>
